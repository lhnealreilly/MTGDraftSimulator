...
async function getPack(){
    ...
    curElem++;
    //Foil Analog
    pack.push(await getCard("https://api.scryfall.com/cards/random?q=%28block%3Ahtr+or+set%3Acmb2+or+%28set%3Apcel+%28t%3Acreature+or+t%3Asummon%29%29+or+%28border%3Asilver+and+usd>%3D7%29%29+-is%3Atoken+-t%3Aland"));
    colorConsistency = colorCheck(colorConsistency, pack[curElem].color);
    curElem++;
    //Rare Analog
